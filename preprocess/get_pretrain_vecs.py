...
def main():
    ...
    parser.add_argument(
        "--dictionary", help="*.dict file", type=str, default="data/entail.word.dict"
    )
    parser.add_argument(
        "--glove",
        help="pretrained word vectors",
        type=str,
        default="/scratch/a9/glove/glove.6B.300d.txt",
    )
    parser.add_argument(
        "--outputfile", help="output hdf5 file", type=str, default="../data/glove.hdf5"
    )
